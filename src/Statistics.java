...
public class Statistics extends javax.swing.JFrame {
    ...
    {
        try{
            String sql="select Book_ID,Book_Name,Edition,Author,Publisher,Price,Pages from issue";
    ...
    {
        try{
            String sql="select Reader_ID,Reader_Name,Email,Mobile,Occupation,Gender from returnbook";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
